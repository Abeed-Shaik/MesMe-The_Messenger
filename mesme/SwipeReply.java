...
public class SwipeReply extends ItemTouchHelper.Callback {
    ...
    public SwipeReply(Context context, SwipeControllerActions swipeControllerActions) {
        super();
    ...
    public int getMovementFlags(@NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        imageDrawable = context.getDrawable(R.drawable.ic_reply_24);
        shareRound = context.getDrawable(R.drawable.reply_layout);
    ...
    private void drawReplyButton(Canvas canvas) {
        ...
        shareRound.setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(context, R.color.lgrey), PorterDuff.Mode.MULTIPLY));
